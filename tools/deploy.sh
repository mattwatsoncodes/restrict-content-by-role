...
echo
echo "WordPress Deployment for Restrict Content by Role ('restrict-content-by-role')"
echo
...
CURRENTDIR=`pwd`
PLUGINSLUG="restrict-content-by-role"
...
svn delete --force $SVNPATH/trunk/assets/raw/repository
